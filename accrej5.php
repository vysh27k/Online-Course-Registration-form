...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    foreach ($updatedStatus as $USN => $status) {
        ...
        $stmt = $conn->prepare("UPDATE course_registration SET Status = ? WHERE USN = ?");
...
$registeredQuery = "SELECT USN, Student_Name, Uploaded_File, Status FROM course_registration";
...
$totalQuery = "SELECT USN, Student_Name FROM total_students";
