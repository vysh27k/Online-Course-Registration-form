...
if (isset($_POST['submit'])) {
    ...
    $validElectives = ['22CST341', '22CST342', '22CST343'];
    ...
    $checkQuery = "SELECT * FROM registered_std3 WHERE USN = '$USN'";
    ...
    if ($result && $result->num_rows > 0) {
        ...
        $sql = "INSERT INTO registered_std3 (Student_Name, USN, Registered_Date, Elective, Counsellor_Name, Uploaded_File)
