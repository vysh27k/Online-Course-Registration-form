...
if (isset($_POST['submit'])) {
    ...
    $validElectives = ['22CST541', '22CST542', '22CST543'];
    ...
    $checkQuery = "SELECT * FROM course_registration WHERE USN = '$USN'";
    ...
    if ($result && $result->num_rows > 0) {
        ...
        $sql = "INSERT INTO course_registration (Student_Name, USN, Registered_Date, Elective, Counsellor_Name, Uploaded_File)
