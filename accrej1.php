...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    foreach ($updatedStatus as $USN => $status) {
        ...
        $stmt = $conn->prepare("UPDATE registered_std1 SET Status = ? WHERE USN = ?");
...
$registeredQuery = "SELECT USN, Student_Name, Uploaded_File, Status FROM registered_std1";
...
$totalQuery = "SELECT USN, Student_Name FROM total_students1";
