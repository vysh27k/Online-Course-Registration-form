...
if (isset($_POST['submit'])) {
    ...
    $validElectives = ['22CST141', '22CST142', '22CST143'];
    ...
    $checkQuery = "SELECT * FROM registered_std1 WHERE USN = '$USN'";
    ...
    if ($result && $result->num_rows > 0) {
        ...
        $sql = "INSERT INTO registered_std1 (Student_Name, USN, Registered_Date, Elective, Counsellor_Name, Uploaded_File)
